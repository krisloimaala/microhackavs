...
$NestedLabScriptURL = "https://github.com/microsoft/MicroHack/raw/refs/heads/main/03-Azure/01-03-Infrastructure/05_Azure_VMware_Solution/Lab/scripts/labdeploy.ps1"
